	...
	<form method="post">
		<table border="1">
			...
			<tr>
				<td rowspan="3">주소</td>
				<td>우편번호</td>
				<td><input type="text" name="address.zipcode"></td> <!-- 우편번호 0으로 시작할수도있으니까 String으로 받는다. -->
			</tr>
			
			<tr>
				<td>주소1</td>
				<td><input type="text" name="address.address1"></td> <!-- 우편번호 0으로 시작할수도있으니까 String으로 받는다. -->
			</tr>
			<tr>
				<td>주소2</td>
				<td><input type="text" name="address.address2"></td> <!-- 우편번호 0으로 시작할수도있으니까 String으로 받는다. -->
			</tr>
			<tr>
				<td></td>
