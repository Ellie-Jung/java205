...
window.onload = function () {
    ...
    regForm.onsubmit = function () {
        ...
        // 사용자가 입력한 값
        // var userid = document.querySelector('#userID').value; // input에 입력시 벨류값에 저장됨
        ...
        if (pw.value.trim() != repw.value.trim()) {
            ...
            document.querySelector('#repw+div.msg').innerHTML = '비밀번호가 일치하지않습니다.'; //캐스팅
            document.querySelector('#repw+div.msg').style.display = 'block';
            //repw.value = '';
            return false;
        }
